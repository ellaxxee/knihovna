<?php
// source: /Applications/MAMP/htdocs/knihovna/config/common.neon
// source: /Applications/MAMP/htdocs/knihovna/config/services.neon
// source: array
...
class Container_708e14201d extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Users\UsersPresenter' => [2 => ['application.1']],
		'App\Presentation\Book\BookPresenter' => [2 => ['application.2']],
	...
	public function createServiceApplication__1(): App\Presentation\Users\UsersPresenter
	{
		$service = new App\Presentation\Users\UsersPresenter($this->getService('database.default.explorer'));
	...
	public function createServiceApplication__2(): App\Presentation\Book\BookPresenter
	{
		$service = new App\Presentation\Book\BookPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Applications/MAMP/htdocs/knihovna/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('/Applications/MAMP/htdocs/knihovna/www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Applications/MAMP/htdocs/knihovna/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Applications/MAMP/htdocs/knihovna/temp/cache',
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;port=8889;dbname=library',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'root'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_708e14201d $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Applications/MAMP/htdocs/knihovna/temp/cache/latte');
